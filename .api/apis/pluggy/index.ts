...
class SDK {
   ...
   * @throws FetchError<400, types.AccountStatementsListResponse400> Missing parameter
   * @throws FetchError<500, types.AccountStatementsListResponse500> Server Internal Error
   */
  accountStatementsList(metadata: types.AccountStatementsListMetadataParam): Promise<FetchResponse<200, types.AccountStatementsListResponse200>> {
    return this.core.fetch('/accounts/{id}/statements', 'get', metadata);
  }
  ...
  /**
   * Retrieves merchant information for a list of CNPJs. Returns an object containing found
   * merchants, valid CNPJs that were not found, and invalid CNPJs.
   *
   * @summary Get merchants by CNPJ list
   */
  merchantsGetByCnpj(metadata?: types.MerchantsGetByCnpjMetadataParam): Promise<FetchResponse<200, types.MerchantsGetByCnpjResponse200>> {
   ...
   * @summary List
   */
  paymentRequestsList(metadata?: types.PaymentRequestsListMetadataParam): Promise<FetchResponse<200, types.PaymentRequestsListResponse200>> {
    return this.core.fetch('/payments/requests', 'get', metadata);
  }
  ...
  /**
   * Creates a payment request where the payment is made using automatic PIX. Once consent is
   * granted by the user, payments can be scheduled according to the rules defined in the
   * request.
   *
   * @summary Create Automatic PIX payment request
   */
  paymentRequestCreateAutomaticPix(body: types.PaymentRequestCreateAutomaticPixBodyParam): Promise<FetchResponse<200, types.PaymentRequestCreateAutomaticPixResponse200>> {
    return this.core.fetch('/payments/requests/automatic-pix', 'post', body);
  }
   ...
   */
  paymentRequestCreateAutomaticPixSchedule(body: types.PaymentRequestCreateAutomaticPixScheduleBodyParam, metadata: types.PaymentRequestCreateAutomaticPixScheduleMetadataParam): Promise<FetchResponse<200, types.PaymentRequestCreateAutomaticPixScheduleResponse200>> {
    return this.core.fetch('/payments/requests/{id}/automatic-pix/schedule', 'post', body, metadata);
  }
   ...
   */
  paymentRequestGetAutomaticPixSchedules(metadata: types.PaymentRequestGetAutomaticPixSchedulesMetadataParam): Promise<FetchResponse<200, types.PaymentRequestGetAutomaticPixSchedulesResponse200>> {
    return this.core.fetch('/payments/requests/{id}/automatic-pix/schedules', 'get', metadata);
  }
   ...
   */
  paymentRequestGetAutomaticPixSchedule(metadata: types.PaymentRequestGetAutomaticPixScheduleMetadataParam): Promise<FetchResponse<200, types.PaymentRequestGetAutomaticPixScheduleResponse200>> {
    return this.core.fetch('/payments/requests/{requestId}/automatic-pix/schedules/{paymentId}', 'get', metadata);
  }
   ...
   */
  paymentRequestCancelAutomaticPixConsent(metadata: types.PaymentRequestCancelAutomaticPixConsentMetadataParam): Promise<FetchResponse<number, unknown>> {
    return this.core.fetch('/payments/requests/{id}/automatic-pix/cancel', 'post', metadata);
  }
   ...
   */
  cancelAutomaticPixSchedule(metadata: types.CancelAutomaticPixScheduleMetadataParam): Promise<FetchResponse<number, unknown>> {
    return this.core.fetch('/payments/requests/{id}/automatic-pix/schedules/{scheduleId}/cancel', 'post', metadata);
  }

  /**
   * Retries an Automatic PIX schedule, only if the authorization accepts retries. The system
   * allows up to 3 retry attempts. Requests must be submitted by 10pm on the day before the
   * scheduled payment date.
   *
   * @summary Retry an Automatic PIX schedule
   */
  retryAutomaticPixSchedule(body: types.RetryAutomaticPixScheduleBodyParam, metadata: types.RetryAutomaticPixScheduleMetadataParam): Promise<FetchResponse<number, unknown>> {
    return this.core.fetch('/payments/requests/{id}/automatic-pix/schedules/{scheduleId}/retry', 'post', body, metadata);
  }
